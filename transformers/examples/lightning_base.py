...
class BaseTransformer(pl.LightningModule):
    def __init__(self, hparams: argparse.Namespace, num_labels=None, mode="base", **config_kwargs):
        ...
        if self.hparams.modify_model:
        # given below is the code to modify the base transformer  
            max_pos=2048
            self.tokenizer.model_max_length=max_pos
            self.tokenizer.init_kwargs['model_max_length'] = 2048
        ...
        if self.hparams.modify_tokenizer :
...
def add_generic_args(parser, root_dir):
    ...
    parser.add_argument("--evaluate_during_training", default=False,type=bool, help="Whether to evaluate during training.")
